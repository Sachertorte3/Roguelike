...
namespace Domain.Service.Characters.Conditions
{
    internal class Blind : IConditionData
    {
        ...
        {
            return target.Status.IsFlagStat(FlagStatType.CannotAct) || target.Status.IsFlagStat(FlagStatType.Blind) ? 0 : CommonSenseParameters.OneTurnStunEquivalentHpReduction / 2;
        }
