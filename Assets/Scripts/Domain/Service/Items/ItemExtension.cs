...
namespace Domain.Service.Items
{
    public static class ItemExtension
    {
        ...
        public static IItemMemento Serialize(this IItem item)
        {
            return item.Match(
                item => item.Serialize(),
                directWeapon => (IItemMemento)directWeapon.Serialize()
            );
        }
        ...
        public static IItem Deserialize(this IItemMemento memento)
        {
            return memento.Match(
                ...
                directWeaponMemento => (IItem)new DirectWeapon(directWeaponMemento)
            );
        }
        ...
        public static IItemMemento Build(this IItemData data, bool isCursed = false, ItemState state = ItemState.None)
        {
            return data.Match(
                ...
                directWeaponData => (IItemMemento)DirectWeapon.Build(directWeaponData, isCursed: isCursed, state: state)
            );
        }
    }
}