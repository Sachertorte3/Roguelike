...
namespace Domain.Model.Memento
{
    public class WorldMemento
    {
        ...
        {
            return new WorldMemento(dungeon ?? Dungeon, player ?? Player, isPlayerDead ?? IsPlayerDead, mapIds ?? MapIds, currentMapId ?? CurrentMapId, itemPlaceholders ?? ItemPlaceholders);
        }
