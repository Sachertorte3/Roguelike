...
| 探索 | 戦闘 | アイテム |
|---|---|---|
| ![](./docs/images/explore.png) | ![](./docs/images/combat.png) | ![](./docs/images/item.png) |

---

## Overview

LogRogue は、ローグライク形式のダンジョン探索ゲームです。

プレイヤーはランダム生成されるダンジョンを探索し、敵と戦い、アイテムを集めながら階層を進みます。

一般的なRPGのように「経験値を稼いでキャラクターを強くする」ことよりも、  
本作では次のような判断を重視しています。
...
- 今の手札で、目の前の局面をどう切り抜けるか

目指しているのは、  
**簡単に始められて、毎局面で「どう切り抜けるか」を考えさせるローグライク**  
です。
