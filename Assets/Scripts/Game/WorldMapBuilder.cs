    ...
    public class WorldMapBuilder
    {
        ...
        public MapMemento Build()
        {
            return new MapMemento(
                ...
                EventEntityManager.Build(_stairs, new List<ChestMemento>(), new List<TrapMemento>(), new List<MoneyMemento>(), Option<BonfireMemento>.None, Option<EntityMemento>.None),
